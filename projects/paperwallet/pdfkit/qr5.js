...
var baseSvg = XML.parse('qr5.min.svg');
...
doc.pipe(fs.createWriteStream('qr5.pdf'))
...
function pagework(prefix) {
    ...
    // Oswald-Regular
    doc.font('fonts/Oswald-Regular.ttf').fontSize(10)
